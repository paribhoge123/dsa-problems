...
LeetCode's actual constraints guarantee a majority element exists, which also allows for a more elegant O(1) space solution (Boyer–Moore Voting Algorithm) — worth revisiting once more comfortable with the hash map approach above.